...
for(let i = 0; i<myArray.length; i++) {
    ...
    console.log("moveOpponent", moveOpponent)

let myMove = myArray[i][1]


if(myMove === "X" && moveOpponent === "rock") {
    myMove = "scissors"
}
if(myMove === "X" && moveOpponent === "paper") {
    myMove = "rock"
}
if(myMove === "X" && moveOpponent === "scissors") {
    myMove = "paper"
}
if(myMove === "Y" ) {
    myMove = moveOpponent
}
if(myMove === "Z" && moveOpponent === "rock") {
    myMove = "paper"
}
if(myMove === "Z" && moveOpponent === "paper") {
    myMove = "scissors"
}
if(myMove === "Z" && moveOpponent === "scissors") {
    myMove = "rock"
}
